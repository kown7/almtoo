...
{
    public static GitOperationResult Success(string operation, string message) => new(operation, true, message);
    public static GitOperationResult Failure(string operation, string message, string? diagnostic = null, GitOperationFailureKind? failureKind = null) =>
...
public record GitOperationResult<T>(
    ...
    GitOperationFailureKind? FailureKind = null)
{
    public static GitOperationResult<T> Success(string operation, string message, T value) => new(operation, true, message, value);
    public static GitOperationResult<T> Failure(string operation, string message, string? diagnostic = null, GitOperationFailureKind? failureKind = null) =>
